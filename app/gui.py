    ...
    def _show_help(self):
        ...
        help_sections = [
            ...
            (
                ...
                "Якщо передача перервалась (мережа, скасування),\n"
                "прогрес зберігається автоматично.\n\n"
                "Для відновлення:\n"
                "1.  Відправник обирає ТОЙ САМИЙ файл\n"
                "2.  Відправник натискає «Надіслати» (новий код)\n"
                "3.  Отримувач вводить новий код\n"
                "4.  Програма автоматично виявить попередню\n"
                "    частину файлу і продовжить з місця зупинки\n\n"
